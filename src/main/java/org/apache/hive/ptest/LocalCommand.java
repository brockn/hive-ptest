...
public class LocalCommand {
  private static final Logger LOG = LoggerFactory
      .getLogger(LocalCommand.class);
  private final Process process;
  private final StreamReader streamReader;
  private Integer exitCode;

  public LocalCommand(String command) throws IOException {
    this(new SystemOutPolicy(), command);
  }
  public LocalCommand(OutputPolicy outputPolicy, String command) throws IOException {
  ...
  public static class SystemOutPolicy implements OutputPolicy {
    private String prefix;
    public SystemOutPolicy() {
      this("");
    }
    public SystemOutPolicy(String prefix) {
      this.prefix = prefix;
    }
    @Override
    public void handleOutput(String line) {
